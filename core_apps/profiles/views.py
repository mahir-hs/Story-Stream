...
from story_api.settings.local import DEFAULT_FROM_EMAIL
    ...
    def post(self, request, user_id, format=None):
        try:
            ...
            message = f"Hi there, {profile.user.first_name}!!, the user {
                user_profile.user.first_name} {user_profile.user.last_name} now follows you"
            ...
            return Response(
                {
                    ...
                    "message": f"{p} ada {self.request.user} {follower} xyz {user_profile.user.last_name} user_id {user_id} does not exist",
                },
            )
